...
public class FiatFactory {
    public Fiat getFiat(String model, int vin) throws ModelNotFoundException {
        return getFiat(model, vin, "");
    }

    public Fiat getFiat(String model, int vin, String version) throws ModelNotFoundException {
